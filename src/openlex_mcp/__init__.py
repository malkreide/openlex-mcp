"""OpenLex MCP — Kanton Zürich Rechtssammlung via MCP."""
...
try:
    ...
    # string lived in the User-Agent (0.2.0) and had drifted from the packaged
    # 0.2.3. A value nobody has to remember to bump cannot go stale.
    __version__ = _distribution_version("openlex-mcp")
