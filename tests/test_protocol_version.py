...
def test_beide_readmes_nennen_die_sdk_anforderung_aus_pyproject() -> None:
    ...
    verwendet. Die englische Fassung war nachgezogen, die deutsche nicht;
    geprueft werden jetzt beide."""
    import tomllib
    ...
    for name, anchor in README_SECTIONS:
        ...
        assert requirement in section, (
            f"{name} nennt nicht die deklarierte Anforderung `{requirement}`"
        )
